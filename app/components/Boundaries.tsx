    ...
    <div className="max-md:!px-5 max-md:!py-14" style={{ alignItems: 'center', backgroundColor: 'var(--color-ivory)', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', fontSize: '12px', fontSynthesis: 'none', lineHeight: '16px', MozOsxFontSmoothing: 'grayscale', overflow: 'clip', paddingBlock: '128px', paddingInline: '60px', position: 'relative', WebkitFontSmoothing: 'antialiased', width: '100%' }}>
      ...
      <div style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'column', maxWidth: '1180px', position: 'relative', width: '100%' }}>
        <div className="max-md:!max-w-full" style={{ alignItems: 'flex-start', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', maxWidth: '760px', paddingBottom: '62px' }}>
          ...
          <div className="max-md:!text-[30px] max-md:!leading-[34px]" style={{ boxSizing: 'border-box', color: 'var(--color-ink)', display: 'inline-block', fontFamily: 'var(--font-display)', fontSize: '58px', fontWeight: 500, letterSpacing: '-0.02em', lineHeight: '62px' }}>
          ...
          <div className="max-md:!max-w-full" style={{ boxSizing: 'border-box', display: 'inline-block', fontFamily: 'var(--font-body)', maxWidth: '600px', paddingTop: '22px' }}>
            <div style={{ boxSizing: 'border-box', color: 'var(--color-graphite)', display: 'inline-block', fontFamily: 'var(--font-body)', fontSize: '19px', lineHeight: '30px', whiteSpaceCollapse: 'preserve' }}>
        ...
        <div className="max-md:!flex-col max-md:!gap-10" style={{ boxSizing: 'border-box', display: 'flex', paddingBottom: '56px', width: '100%' }}>
          <motion.div whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 300, damping: 28 }} className="max-md:!w-full max-md:!shrink max-md:!pr-0 cursor-default" style={{ boxSizing: 'border-box', display: 'flex', flexBasis: '0%', flexDirection: 'column', flexGrow: '1', minWidth: '0px', paddingRight: '60px' }}>
            ...
            <div style={{ alignItems: 'flex-start', borderTopColor: 'var(--color-line)', borderTopStyle: 'solid', borderTopWidth: '1px', boxSizing: 'border-box', display: 'flex', gap: '16px', paddingBlock: '20px' }}>
              ...
              <div style={{ boxSizing: 'border-box', color: 'var(--color-ink)', display: 'inline-block', fontFamily: 'var(--font-body)', fontSize: '18px', lineHeight: '27px', whiteSpaceCollapse: 'preserve' }}>
          ...
          <motion.div whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 300, damping: 28 }} className="max-md:!w-full max-md:!shrink max-md:!border-l-0 max-md:!pl-0 cursor-default" style={{ borderLeftColor: 'var(--color-line)', borderLeftStyle: 'solid', borderLeftWidth: '1px', boxSizing: 'border-box', display: 'flex', flexBasis: '0%', flexDirection: 'column', flexGrow: '1', minWidth: '0px', paddingLeft: '60px' }}>
            <div style={{ alignItems: 'center', boxSizing: 'border-box', display: 'flex', gap: '10px', paddingBottom: '30px' }}>
            ...
            <div style={{ alignItems: 'flex-start', borderTopColor: 'var(--color-line)', borderTopStyle: 'solid', borderTopWidth: '1px', boxSizing: 'border-box', display: 'flex', gap: '16px', paddingBlock: '20px' }}>
              ...
              <div style={{ boxSizing: 'border-box', color: 'var(--color-graphite)', display: 'inline-block', fontFamily: 'var(--font-body)', fontSize: '18px', lineHeight: '27px', whiteSpaceCollapse: 'preserve' }}>
        ...
        <motion.div whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 300, damping: 28 }} className="max-md:!py-8 max-md:!px-6 max-md:!gap-4 cursor-default" style={{ alignItems: 'flex-start', backgroundColor: 'var(--color-ink)', borderRadius: '18px', boxSizing: 'border-box', display: 'flex', gap: '24px', overflow: 'clip', paddingBlock: '42px', paddingInline: '46px', position: 'relative', width: '100%' }}>
          ...
          <div style={{ boxSizing: 'border-box', color: 'var(--color-gold)', display: 'inline-block', flexShrink: '0', fontFamily: 'var(--font-display)', fontSize: '56px', fontWeight: 500, lineHeight: '40px', position: 'relative' }}>
            “
          </div>
          <div style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'column', gap: '14px', position: 'relative' }}>
            <div className="max-md:!text-[21px] max-md:!leading-[28px] max-md:!max-w-full" style={{ boxSizing: 'border-box', color: 'var(--color-cream)', display: 'inline-block', fontFamily: 'var(--font-quote)', fontSize: '30px', fontStyle: 'italic', lineHeight: '38px', maxWidth: '800px' }}>
